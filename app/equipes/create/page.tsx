...
import { Users, CheckCircle, Loader2, HelpCircle, Clock, Info } from "lucide-react"
...
export default function CreateEquipePage() {
  ...
  return (
    <Layout title="Nova Equipe - EstimAÍ" subtitle="Crie uma nova equipe de desenvolvimento no EstimAÍ">
                        ...
                        <div key={item.key} className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <Badge variant="outline" className="bg-amber-50 text-amber-700">
                              {formData[item.key as keyof CreateEquipeDto] as number}
                            </Badge>
                          </div>
                          <Slider
                ...
                <Card className="shadow-2xl border-0 bg-gradient-to-br from-green-50 to-blue-50 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-green-500 to-blue-500 text-white text-center">
                    <CardTitle className="text-2xl flex items-center justify-center gap-2">
                      ...
                      Equipe Criada com Sucesso no EstimAÍ!
                    </CardTitle>
