...
export default function CreateStoryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({
        ...
        description: "A nova história foi criada com sucesso.",
      })
  ...
  if (loadingData) {
    return (
      <Layout title="Nova História" subtitle="Carregando dados...">
  ...
  return (
    <Layout title="Nova História" subtitle="Crie uma nova história e calcule as estimativas">
              ...
              >
                <Card className="shadow-2xl border-0 bg-gradient-to-br from-green-50 to-blue-50 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-green-500 to-blue-500 text-white text-center">
                    ...
                    <CardDescription className="text-green-100">Estimativas calculadas automaticamente</CardDescription>
                  </CardHeader>
